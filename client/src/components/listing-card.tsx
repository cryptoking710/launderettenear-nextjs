...
export function ListingCard({ listing, distance, averageRating, reviewCount }: ListingCardProps) {
  return (
    <Link href={`/launderette/${listing.id}`}>
      <Card 
        className={`p-6 transition-all duration-200 hover:shadow-xl cursor-pointer ${

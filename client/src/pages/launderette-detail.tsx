...
export default function LaunderetteDetail() {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      document.title = "Launderette Near Me | Find 702+ UK Launderettes & Laundrettes | LaunderetteNear.me";
      
      const metaDescription = document.querySelector('meta[name="description"]');
      if (metaDescription) {
        metaDescription.setAttribute('content', 
          "Find your nearest launderette in seconds. Search 702+ launderettes across 68 UK cities. Service wash, 24 hour, self-service & more. Real reviews, opening hours & prices."
        );
      }
    };
  }, [launderette, reviews]);

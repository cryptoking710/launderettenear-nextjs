...
async function importLaunderettes() {
  console.log('🌱 Importing Southampton, Nottingham & Leicester launderettes (30 locations)...\n');
  
  const jsonPath = path.join(__dirname, '..', 'sample-data', 'southampton-nottingham-leicester.json');

...
async function importLaunderettes() {
  console.log('🌱 Importing Wakefield, Portsmouth & Aberdeen (Extra) launderettes (30 locations)...\n');
  
  const jsonPath = path.join(__dirname, '..', 'sample-data', 'wakefield-portsmouth-aberdeen-extra.json');

...
async function importLaunderettes() {
  console.log('🌱 Importing Liverpool, Bristol & Newcastle launderettes (30 locations)...\n');
  
  const jsonPath = path.join(__dirname, '..', 'sample-data', 'liverpool-bristol-newcastle.json');
